...
const ArchivePage = () => {
    ...
    // The archive will contain messages from all folders, no matter it is inbox, cc, or follow-up:
    const [folder, setFolder] = useState<FolderType>(FolderType.All);
    const [filterBy, setFilterBy] = useState<string>("");
    const [filterPayload, setFilterPayload] = useState<any>({isArchived: true});
